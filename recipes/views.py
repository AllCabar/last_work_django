...
class LoginUser(LoginView):
    ...
    template_name = 'recipes/log_in.html'
...
def show_one_recipe(request):
    ...
    return render(request, 'recipes/One_recipe.html', {
        'recipe': recipe,
    })
...
class UpdateRecipe(UpdateView):
    ...
    fields = '__all__'
    recipe = Recipe.objects.annotate()
    template_name = 'recipes/CreateRecipeEdit.html'
...
class AllRecipe(ListView):
    template_name = 'recipes/All_Recipe.html'
    model = Recipe
    context_object_name = 'recipes'
